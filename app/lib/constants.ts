...
export const GAME_ABI = parseAbi([
  ...
  "function settleEpochsDust(uint256[] calldata rewardEpochs) external",
  "function settleEpochRebateDust(uint256 epoch) external",
  "function settleEpochsRebateDust(uint256[] calldata rebateEpochs) external",
