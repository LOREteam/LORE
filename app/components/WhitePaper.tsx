    ...
    <div className="flex-1 overflow-y-auto pb-24 animate-fade-in">
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        <Section id="privy" badge="07" title="Privy Embedded Wallet" icon={WalletIcon} delay={0.3}>
          ...
          <P>This means:</P>
          <ul className="space-y-2 mb-6 ml-1">
            <Li emoji="🔐">Login with email or an existing external wallet</Li>
            <Li emoji="🧭">Email sign-in normally creates the embedded wallet; if it is not ready, create it in Wallet Settings. The same enabled method can restore normal access while available; export and protect the private key before funding for independent recovery</Li>
