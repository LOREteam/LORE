...
export const achievementDefs: AchievementDef[] = [
  ...
  { id: "jackpot_5k", title: "Lucky Vein", description: "Win 5k LINEA from one epoch", icon: "💰", progress: (s) => `${fmtK(Math.min(s.maxReward, 5000))}/${fmtK(5000)}`, unlocked: (s) => s.maxReward >= 5000 },
  { id: "jackpot_10k", title: "Gold Rush", description: "Win 10k LINEA from one epoch", icon: "💸", progress: (s) => `${fmtK(Math.min(s.maxReward, 10000))}/${fmtK(10000)}`, unlocked: (s) => s.maxReward >= 10000 },
  { id: "jackpot_50k", title: "Deep Vein", description: "Win 50k LINEA from one epoch", icon: "🪙", progress: (s) => `${fmtK(Math.min(s.maxReward, 50000))}/${fmtK(50000)}`, unlocked: (s) => s.maxReward >= 50000 },
  { id: "jackpot_100k", title: "Motherlode", description: "Win 100k LINEA from one epoch", icon: "👑", progress: (s) => `${fmtK(Math.min(s.maxReward, 100000))}/${fmtK(100000)}`, unlocked: (s) => s.maxReward >= 100000 },
