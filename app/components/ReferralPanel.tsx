  ...
  return (
    <div className="flex-1 overflow-y-auto pb-12 animate-fade-in">
      <div className="max-w-2xl mx-auto px-4 md:px-8 pt-6">
        ...
        {/* How it works */}
        <div className="p-4 rounded-xl bg-[#0d0d1a] border border-violet-500/20 mb-4 animate-slide-up" style={{ animationDelay: "0.15s" }}>
          <h2 className="text-xs font-bold text-white uppercase tracking-wider mb-3">How it works</h2>
        ...
        {!address ? (
          <div className="p-4 rounded-xl bg-[#0d0d1a] border border-violet-500/20 mb-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            <p className="text-sm text-gray-500 text-center py-4">Connect your wallet to get started.</p>
          </div>
        ) : !hasCode ? (
          /* No code yet – register */
          <div className="p-4 rounded-xl bg-[#0d0d1a] border border-violet-500/20 mb-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            <h2 className="text-xs font-bold text-white uppercase tracking-wider mb-2">Step 1: Register Your Code</h2>
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wider bg-violet-600 hover:bg-violet-500 text-white transition-all active:scale-95 disabled:opacity-40"
            >
          ...
          <>
            <div className="p-4 rounded-xl bg-[#0d0d1a] border border-violet-500/20 mb-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
              <h2 className="text-xs font-bold text-white uppercase tracking-wider mb-1">Your Referral Code</h2>
              <div className="text-lg font-black text-violet-400 font-mono mb-3 tracking-widest">{referralInfo!.code!.toUpperCase()}</div>
              <h2 className="text-xs font-bold text-white uppercase tracking-wider mb-2">Your Referral Link</h2>
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-lg font-bold text-xs uppercase tracking-wider bg-violet-600 hover:bg-violet-500 text-white transition-all active:scale-95 disabled:opacity-40"
                >
                  {copied ? "Copied!" : "Copy"}
                </button>
              </div>
            ...
            {/* Earnings + Claim */}
            <div className="p-4 rounded-xl bg-[#0d0d1a] border border-emerald-500/20 mb-4 animate-slide-up" style={{ animationDelay: "0.25s" }}>
              <h2 className="text-xs font-bold text-white uppercase tracking-wider mb-3">Earnings</h2>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-lg font-bold text-xs uppercase tracking-wider border transition-all active:scale-95 disabled:opacity-30 bg-emerald-500/10 border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/15"
              >
        ...
        {isSettingReferrer && (
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-sky-500/10 border border-sky-500/25 text-sky-400 text-xs font-bold uppercase tracking-wider mb-4 animate-slide-up">
        ...
        {/* FAQ */}
        <div className="p-4 rounded-xl bg-[#0d0d1a] border border-violet-500/20 animate-slide-up" style={{ animationDelay: "0.35s" }}>
          <h2 className="text-xs font-bold text-white uppercase tracking-wider mb-3">FAQ</h2>
          <div className="space-y-3">
...
function StatBox({ label, value, accent }: { label: string; value: string; accent: string }) {
  ...
  return (
    <div className={`p-3 rounded-xl bg-[#0d0d1a] border ${colors[accent]}`}>
