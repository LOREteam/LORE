...
- [ ] Continue replacing source-string guards with imported behavior and reduce
      the remaining 15,612-line business-test coordinator. The pending-nonce
      ...
      presentation, runtime-polling, and chat-polling tests now run from their own
      imported modules; pure game-data, canary-health, and chat retry bounds use
