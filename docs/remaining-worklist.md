...
- [ ] Continue replacing source-string guards with imported behavior and reduce
      the remaining 9,419-line business-test coordinator. The API-recovery/storage,
      ...
      presentation, runtime-metrics, error-boundary, runtime-polling, chat-polling, chat-content, release-operations, and wallet/route-safety tests now run from
