...
- [ ] Continue replacing source-string guards with imported behavior and reduce
      the remaining 7,166-line business-test coordinator. The client-identity/
      ...
      runtime-health-diagnostics, and public-metadata assertions now also
      execute from isolated imported modules.
- [ ] Seal an exact-diff security bundle for the current test-only follow-up
      `b8c7f669..f02222e0` before treating it as part of the final candidate;
