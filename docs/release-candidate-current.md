...
`cc0d5891159065eaa51d59607b250eda1aee3014` on `codex/repo-cleanup`.
...
evidence boundary for the documentation-only clean-HEAD runtime-role wiring
record containing this manifest.
...
- Canonical current content-set SHA-256 for the other `4` candidate files (this
  ...
  `4b7a5d2f400331f1e111d6fc7ae113324a56348115af21a27d776e372f381bdb`.
