...
- Added compiler-derived V10 ABI snapshot/fragments/digest, an executable EVM
  ...
  P1 orchestration.
- Split twenty-one business-test domains out of the monolith, including the isolated
  ...
  client-identity/external-rate-limit, wallet-shell/mining-action, and mining-runtime
  safety assertions. The coordinator is now 7,809 lines; Pure game-data, runtime-metrics,
