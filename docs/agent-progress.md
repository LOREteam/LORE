...
- Added compiler-derived V10 ABI snapshot/fragments/digest, an executable EVM
  ...
  P1 orchestration.
- Split twenty-two business-test domains out of the monolith, including the isolated
  ...
  and explorer-link assertions. The coordinator is now 7,792 lines; Pure game-data, runtime-metrics,
