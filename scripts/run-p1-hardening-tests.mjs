...
const CORE_STEPS = [
  ...
  // The fixture suite performs isolated Git/project setup and 30 offline child
  // checks. On the pinned Windows runtime it can legitimately exceed 150s by a
  // small scheduling margin, so retain a bounded budget without turning a
  // passing suite into a false timeout.
  { id: "preview-env-boundary", file: "scripts/test-v10-preview-env-boundary.mjs", timeoutMs: 210_000 },
